...
INSERT INTO public.operations (versionno, extra, module, controller, action, featureref)
SELECT 1, NULL, 'DIM', 'DataCiteDoi', '*', (Select id from features where 
    ((name = 'Data Dissemination') 
    and
    ( features.id NOT in (SELECT featureref FROM public.operations WHERE module='DIM' AND controller='DataCiteDoi'))
    and 
    (features.parentref is NOT NULL )));
