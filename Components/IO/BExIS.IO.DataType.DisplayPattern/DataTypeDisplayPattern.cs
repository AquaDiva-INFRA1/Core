...
namespace BExIS.IO.DataType.DisplayPattern
{
    public class DataTypeDisplayPattern
    {
        private static List<DataTypeDisplayPattern> displayPatterns = new List<DataTypeDisplayPattern>()
        {
            ...
            new DataTypeDisplayPattern() {Systemtype = DataTypeCode.DateTime,   Name = "DateTimeWithPoints",       ExcelPattern=@"dd\.MM\.yyyy hh:mm:ss", DisplayPattern = "dd.MM.yyyy hh:mm:ss",     StringPattern = "dd.MM.yyyy HH:mm:ss",      RegexPattern = null},
            ...
            new DataTypeDisplayPattern() {Systemtype = DataTypeCode.DateTime,   Name = "DateIso",           ExcelPattern="dd-mm-yyyy",          DisplayPattern= "dd-mm-yyyy",               StringPattern = "dd-mm-yyyy",               RegexPattern = null},
