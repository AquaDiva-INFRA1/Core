using BExIS.Modules.HomePage.UI.Helpers;
using System;
using Vaiona.Logging;
using Vaiona.Web.Mvc.Modularity;

namespace BExIS.Modules.HomePage.UI
{
    public class HomePageModule : ModuleBase
    {
        public HomePageModule() : base("HomePage")
        {
            LoggerFactory.GetFileLogger().LogCustom("...ctor of HomePage...");
        }

        public override void Install()
        {
            LoggerFactory.GetFileLogger().LogCustom("...start install of HomePage...");
            try
            {
                base.Install();
                using (HomePageSeedDataGenerator generator = new HomePageSeedDataGenerator())
                {
            ...
            LoggerFactory.GetFileLogger().LogCustom("...end install of HomePage...");
