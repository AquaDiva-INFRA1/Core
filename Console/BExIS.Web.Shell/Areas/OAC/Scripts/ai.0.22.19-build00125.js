...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            ...
            _InternalMessageId[_InternalMessageId["NONUSRACT_MissingRequirOACieldSpecification"] = 23] = "NONUSRACT_MissingRequirOACieldSpecification";
            ...
            Serializer._serializeObject = function (source, name) {
                ...
                for (var field in source.aiDataContract) {
                    ...
                    if (isRequired && !isPresent && !isArray) {
                        ApplicationInsights._InternalLogging.throwInternalNonUserActionable(ApplicationInsights.LoggingSeverity.CRITICAL, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_MissingRequirOACieldSpecification, "Missing required field specification. The field is required but not present on source", { field: field, name: name }));
                        continue;
                    }
                    if (isHidden) {
                        continue;
        ...
        var DataLossAnalyzer = (function () {
            ...
            DataLossAnalyzer.reset = function () {
                if (DataLossAnalyzer.isEnabled()) {
                    ...
                    DataLossAnalyzer.itemsRestorOACromSessionBuffer = 0;
                }
            };
            ...
            DataLossAnalyzer.reportLostItems = function () {
                try {
                    if (DataLossAnalyzer.isEnabled() &&
                        ...
                        var lostItems = DataLossAnalyzer.getNumberOfLostItems() - DataLossAnalyzer.itemsRestorOACromSessionBuffer;
    ...
    (function (ApplicationInsights) {
        ...
        var SessionStorageSendBuffer = (function () {
            function SessionStorageSendBuffer(config) {
                ...
                ApplicationInsights.DataLossAnalyzer.itemsRestorOACromSessionBuffer = this._buffer.length;
